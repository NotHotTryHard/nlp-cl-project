...
class Encoder(nn.Module):
    def __init__(self, model_config):
        ...
        self.layer_stack = nn.ModuleList([FFTBlock(
            ...
            d_inner=model_config["encoder_feedforward_dim"],
...
class Decoder(nn.Module):
    ...
    def __init__(self, model_config, len_max_seq=None):
        ...
        self.layer_stack = nn.ModuleList([FFTBlock(
            ...
            d_inner=model_config["decoder_feedforward_dim"],
    ...
    def forward(self, enc_seq, enc_pos, return_attns=False):
        ...
        # -- Forward
        tok_emb = self.token_enc(enc_seq)
        pos_emb = self.position_enc(enc_pos)[:, :tok_emb.shape[1], :]
        print(tok_emb.shape, pos_emb.shape)
        dec_output = tok_emb + pos_emb
